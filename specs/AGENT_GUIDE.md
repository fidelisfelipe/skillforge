...
Siga a hierarquia do `PRINCIPLES.md`:
...
Cada hero tem sua pasta em `specs/heroes/{hero-id}/` com quatro arquivos:

```
specs/heroes/{hero-id}/
...
- `PRINCIPLES.md` — princípios e hierarquia de modelos do projeto
- `hero-template/` — módulo Spring Boot base para novos heroes
- `docs/learn-claude/` — guia de estudo progressivo para devs
- `specs/heroes/` — definições concretas de cada hero
- `specs/templates/` — templates reutilizáveis de system prompt