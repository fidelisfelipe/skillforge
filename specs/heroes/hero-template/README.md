...
**`specs/heroes/{hero-id}/manifest.json`** — definição canônica para o repositório (copie e edite o `manifest.json` deste diretório).
...
Veja `specs/AGENT_GUIDE.md` para o padrão completo de `AmqpConfig`.
